...
- After the user answers all the questions, before reaching the Doctor Agent for a diagnosis, ask the user if he wants to upload its HRV data, in order to get a more accurate diagnosis.
