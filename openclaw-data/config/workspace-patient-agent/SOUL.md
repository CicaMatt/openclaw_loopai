...
- Return the received diagnosis to the user, as-is, making clear that it comes from the Doctor Agent. At the end of the message, ALWAYS suggest him to recall the distillation tool to get a comprehensive medical report of the conversation and the suggested next steps.
